...
def hinkel_spel():
    ...
    aantal_tegels_gemaakt, parcour_lengte, gamemode, reverse, tegel_move_aftegel, player_bij_start, eerste_sprong, parcour_vermeerdering, score_vermeerderd, laatste_tegel_versnelling, game_state, move_score, aantal_keren_bij_start, verleng_parcour
    ...
    game_state = "tutorial" #starting_screen, playing, end_screen, tutorial
    ...
    def reset_game():
        ...
        score_vermeerderd = True
        laatste_tegel_versnelling = False
        heart_group = [heart1 := Heart("move_again-main\move_again-main\graphics\pixel_heart.webp",screen_x/8,5*screen_y/8), \
                           heart2 :=Heart("move_again-main\move_again-main\graphics\pixel_heart.webp",screen_x/8,screen_y/2), \
                           heart3 := Heart("move_again-main\move_again-main\graphics\pixel_heart.webp",screen_x/8,6*screen_y/8)]
    ...
    class Score_indicator:
        ...
        def check_kleur(self):
            global score, heart_group, reset_game, game_state
